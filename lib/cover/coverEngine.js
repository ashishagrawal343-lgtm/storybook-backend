    ...
    async generateCover({
        ...
        if (characterReferenceUrl) {
            ...
            try {
                ...
                // Build exclusion clause — only forbid items the child does NOT have
                ...
                // IMPORTANT: avoid words scrubbed by the safety sanitizer:
                //   - "skin tone" / "complexion" → scrubbed to "gentle warm glow" → ruins prompt
                //   - "natural skin" → also scrubbed
                // Use "exact face colouring from the reference photo" instead.
                // Also avoid "skin tone" in the preserve list — use "face colouring and pigmentation from the reference photo" 
