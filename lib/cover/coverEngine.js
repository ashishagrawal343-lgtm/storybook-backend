...
class CoverDesignEngine {
    ...
    async generateCover({
        ...
        // Step 1: Resolve Character Reference Anchor (Customer Photo -> Direct Photo Conditioning)
        ...
        if (characterReferenceUrl) {
            ...
            console.log(`👤 [CoverEngine v2] Fast single-pass photo conditioning active for "${childName}" (direct flux-kontext-pro)...`);
        }
