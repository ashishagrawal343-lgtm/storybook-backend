...
function generateCoverTypographySvg({
    ...
    if (nonLatin) {
        ...
        kickerText = `A TWINKLETALE ADVENTURE FOR ${cleanChildName.toUpperCase()}`;
    }
    ...
    const footerText = 'TWINKLETALE PUBLISHING';
    ...
    <svg width="${zones.canvas.width}" height="${zones.canvas.height}" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="${zones.canvas.width / 2}" y="${kickerY}" text-anchor="middle"
              ...
              letter-spacing="${nonLatin ? '0.5' : '2.5'}" word-spacing="${nonLatin ? 'normal' : '10px'}" xml:space="preserve" opacity="0.95"
        ...
        <text x="${zones.canvas.width / 2}" y="${footerY}" text-anchor="middle"
              ...
              letter-spacing="3.0" word-spacing="12px" xml:space="preserve" opacity="0.80"
