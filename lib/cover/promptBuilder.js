...
function buildCoverPrompt(themeInput, archetypeInput, child, options = {}) {
    ...
    if (attributes && attributes.skinTone) {
        // Use sanitizer-safe wording: "skin tone/complexion" gets scrubbed → use "face colouring" and "pigmentation" instead
        attributePrefix += `(authentic ${attributes.skinTone} face colouring:1.2), `;
