...
function buildCoverPrompt(themeInput, archetypeInput, child, options = {}) {
    ...
    if (attributes && attributes.skinTone) {
        ...
        attributeNegativeTokens.push(
            'incorrect skin tone', 'altered ethnicity', 'discolored skin', 'unnatural skin tone shift'
        );
    }

    // Facial likeness & structure preservation directive (90-95% fidelity in lush painterly realism)
    const likenessDirective = "[PORTRAIT FIDELITY: Maintain 90% to 95% authentic facial likeness from the reference photo: preserve exact eye shape, iris tone, eyebrow contour, nose bridge and tip, mouth and lip shape, authentic happy smile, and natural soft dimensional skin tone without cartoon or CGI distortion, while seamlessly rendered in lush painterly storybook realism, soft digital gouache and fine oils texture, and gentle golden rim lighting.] ";
